python practitioner_aidbox.py -u $AIDBOX_URL -t $AIDBOX_AUTH_TOKEN
python organisation_aidbox.py -u $AIDBOX_URL -t $AIDBOX_AUTH_TOKEN
python practitionerRole_aidbox.py -u $AIDBOX_URL -t $AIDBOX_AUTH_TOKEN
...
python familyMemberHistory_aidbox.py -u $AIDBOX_URL -t $AIDBOX_AUTH_TOKEN
python researchStudy_aidbox.py -u $AIDBOX_URL -t $AIDBOX_AUTH_TOKEN